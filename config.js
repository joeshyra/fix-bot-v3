...
/*============== PAYMENT ==============*/
global.pdana = '0881336721352' //dana
...
global.linkgithub = 'https://github.com/NazrilOfficial' // tarok link github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['6281336721352', 'ZRILL DEV OWNER2', true],
  ['6281393160368', 'NAZRILOfficial', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['6282260297438', 'NO BOTZ NAZRIL', true]
...
/*============== WATERMARK ==============*/
global.wm = '                「 DEV-BOT-V1 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘DEV-BOT-V1 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ DEV-BOT-V1 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By ZRIILL-DEV`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 DEV-BOT-V1  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'DEV-BOT-V1'
global.stickauth = `By ©ZRIILL-DEV`
